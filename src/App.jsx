...
const App = () => {
    ...
    const vote = useVote("0x8C91570B1275dD0Ac38664ABA4c61e46e3A7d354");
    const token = useToken("0xb6264C218c62230631489D02792D8BaFCd5CFb40");
    const editionDrop = useEditionDrop("0x44668372070062B4aB166e2cd20f4Dde1362053d");
    ...
    if (!address) {
        return (
            <div className="landing">
                <h1>🎶 🎶 🎶 Welcome to Ilaiyaraaja Fans DAO</h1>
    ...
    if (hasClaimedNFT) {
        return (
            <div className="member-page">
                <h1>🎶 🎹 Ilaiyaraaja Fans DAO Member Page</h1>
    ...
    return (
        <div className="mint-nft">
            <h1>Mint your free 🎶 laiyaraaja Fans DAO  Membership  NFT</h1>
